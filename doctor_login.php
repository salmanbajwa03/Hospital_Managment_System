...
<body style="font-family:'Trebuchet MS', Helvetica, sans-serif;">
	<div class="jumbotron" style=" background-image: linear-gradient(to left, #00e600,#000099 );color:white;">
		<div class="container">
			...
			<span style="margin-left:-30px;font-size:34px;text-shadow: 2px 2px 5px #80ff80"><font face="algerian  ">Hospital Managmet system</font></span>
		</div>
	</div>
	...
	<div class="container">	
		<div class="row">
			...
			<div class="col-sm-6" style="background-color:">
				<center><img src="img\doctor1.png" height="50" width="50">
				<span style="font-size:24px">Doctor Login</span><hr></center>
	...
	<?php
		if(isset($_POST['submit_btn'])){
			...
			$sql = "SELECT *FROM Doctor WHERE doctor_email = '$our_email'";
			...
			if($our_password == $our_pass){
				echo "<script>window.location.href='doctor_home.php';</script>";
			}
			else{
